...
export const DATA = {
	...
	description: 'I turn visionary ideas into tangible, user-friendly solutions.',
	summary: `I love building things and helping people. I am a fresh graduate from [UCSD](/#education) with a degree in computer science.  
    Created [UUSphere](#projects) –––– a social platform that helps connect and support UCSD students with their academic lives.  
    I'm passionate about turning visionary ideas into tangible, user-friendly solutions.`,
	...
	work: [
		{
			company: 'Tract',
			href: 'https://www.usetract.com/',
			badges: [],
			location: 'Remote',
			title: 'Software Engineer Intern',
			logoUrl: '/images/tract.png',
			start: 'Jun 2023',
			end: 'Sep 2023',
			description: [
				'Developed an AI chatbot for a web application that provides tailored outputs for 5,000+ early users by applying the RAG technique, which integrated the GPT model with the Mongodb database using LangChain.',
				'Deployed the Flask server with uWSGI and Nginx on AWS EC2, and set up https for data security.',
			],
		},
		{
			...
			location: 'Remote',
			title: 'Software Engineer Intern',
			logoUrl: '/images/cp-group.png',
			start: 'Jun 2021',
			end: 'Sep 2021',
			description: [
				"Implemented a responsive website that helps promote the company's mission to 20,000+ customers.",
				'Developed an online code editor, including dashboard and file management, which enables synchronous coding.',
			],
		},
	],
	education: [
		{
			...
			logoUrl: '/images/ucsd.png',
			start: 'Sep 2022',
			end: 'Jun 2024',
			description: [
				'Publication: Lu Sun et al., NewsGuesser: Using Curiosity to Reduce Selective Exposure, CSCW, 2023.',
			],
		},
		{
			school: 'University of California, San Diego',
			...
			description: [
				'Tutor for CSE 130: Programming Languages.',
				'Provided guidance during office hours to 60 students, supporting their learning of Haskell and Lambda calculus.',
			],
		},
	],
	hackathons: [
